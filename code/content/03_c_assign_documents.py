...
def plot_counts_per_topic(idx_lists):
    ...
    # Save the figure
    fig_name = os.path.join(project_dir, 'TOPIC/CONTENT/PLOT/plot.png')
...
with open(project_dir + 'TOPIC/CONTENT/case_list.txt', "w") as file:
    file.write(str(case_lists))
 
with open(project_dir + 'TOPIC/CONTENT/idx_list.txt', "w") as file:
    file.write(str(idx_lists))

'''
import pickle
with open(project_dir + 'TOPIC/CONTENT/case_list.txt', "wb") as f:
    pickle.dump(case_lists, f)

with open(project_dir + 'TOPIC/CONTENT/case_list.txt', "rb") as f:
    pickle.dump(idx_lists, f)
'''
